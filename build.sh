...
git clone --depth=1 https://github.com/parikk/device_xiaomi_lmi.git -b 13-pixelos device/xiaomi/lmi
...
make bacon -j16  > reading & sleep 95m # Jangan di hapus text line (> reading)
